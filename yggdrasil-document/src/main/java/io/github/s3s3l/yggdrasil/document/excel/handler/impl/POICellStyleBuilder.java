package io.github.s3s3l.yggdrasil.document.excel.handler.impl;
...
import io.github.s3s3l.yggdrasil.document.excel.handler.CellStyleBuilder;
...
public class POICellStyleBuilder implements CellStyleBuilder {
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setAlignment(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setVerticalAlignment(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setBorderLeft(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setBorderRight(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setBorderTop(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setBorderBottom(short)
     */
    @Override
    @Deprecated
    ...
    /**
     * @deprecated
     * @see io.github.s3s3l.yggdrasil.utils.excel.handler.CellStyleBuilder#setFillPattern(short)
     */
    @Override
    @Deprecated
