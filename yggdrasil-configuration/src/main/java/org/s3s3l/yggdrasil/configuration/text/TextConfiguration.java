package org.s3s3l.yggdrasil.configuration.text;

import java.util.Map;
import java.util.Optional;

import org.s3s3l.yggdrasil.bean.exception.ConfigurationNotInitializedException;
import org.s3s3l.yggdrasil.bean.exception.TextNotFoundException;
