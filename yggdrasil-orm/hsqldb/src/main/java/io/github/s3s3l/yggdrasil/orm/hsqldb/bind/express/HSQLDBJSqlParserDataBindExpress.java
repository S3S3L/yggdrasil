...
public class HSQLDBJSqlParserDataBindExpress extends JSqlParserDataBindExpress {

    public HSQLDBJSqlParserDataBindExpress(MetaManager metaManager, DbTypeHandlerFactory dbTypeHandlerFactory) {
    ...
    public SqlStruct getColumnAlter(ColumnMeta columnMeta) {
        ...
        ColumnDataType columnDataType = new ColumnDataType(columnMeta.getName(), false, colDataType, null);
