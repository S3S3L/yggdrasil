...
public abstract class JSqlParserDataBindExpress implements DataBindExpress {
    ...
    protected final DbTypeHandler dbTypeHandler;

    public JSqlParserDataBindExpress(MetaManager metaManager, DbTypeHandlerFactory dbTypeHandlerFactory) {
        this.metaManager = metaManager;
        this.dbTypeHandler = dbTypeHandlerFactory.getInstance(databaseType());
    }
    ...
    public SqlStruct getCreate(Class<?> tableType, boolean force) {
        ...
        sqlStruct.appendSql(new CreateBuilder(table, force).build(dbTypeHandler)
                .toString());
        return sqlStruct;
    }
