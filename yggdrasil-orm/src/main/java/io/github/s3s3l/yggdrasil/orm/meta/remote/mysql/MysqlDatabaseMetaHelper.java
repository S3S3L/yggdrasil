package io.github.s3s3l.yggdrasil.orm.meta.remote.mysql;
...
import io.github.s3s3l.yggdrasil.orm.meta.remote.mysql.columns.MysqlColumnMetaColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.mysql.columns.MysqlPkColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.mysql.columns.MysqlTableMetaColumns;
            ...
            return datasourceHolder.useConn(conn -> {
                ...
                while (rs.next()) {
                    ...
                    DbType dbType = DbType.builder()
                            ...
                            .type(rs.getString(MysqlColumnMetaColumns.TYPE_NAME.name()))
                            .build();
                    switch (dataType) {
                        // varchar
                        case 12:
