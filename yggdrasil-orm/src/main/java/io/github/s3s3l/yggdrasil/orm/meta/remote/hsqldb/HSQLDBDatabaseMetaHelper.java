package io.github.s3s3l.yggdrasil.orm.meta.remote.hsqldb;
...
import io.github.s3s3l.yggdrasil.orm.meta.remote.hsqldb.columns.HSQLDBColumnMetaColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.hsqldb.columns.HSQLDBPkColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.hsqldb.columns.HSQLDBTableMetaColumns;
            ...
            return datasourceHolder.useConn(conn -> {
                ...
                while (rs.next()) {
                    ...
                    DbType dbType = DbType.builder()
                            ...
                            .type(rs.getString(HSQLDBColumnMetaColumns.TYPE_NAME.name()))
                            .build();
                    switch (dataType) {
                        // varchar
                        case 12:
