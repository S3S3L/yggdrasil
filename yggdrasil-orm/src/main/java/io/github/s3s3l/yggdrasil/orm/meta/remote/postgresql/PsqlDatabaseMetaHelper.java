package io.github.s3s3l.yggdrasil.orm.meta.remote.postgresql;
...
import io.github.s3s3l.yggdrasil.orm.meta.remote.postgresql.columns.PsqlColumnMetaColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.postgresql.columns.PsqlPkColumns;
import io.github.s3s3l.yggdrasil.orm.meta.remote.postgresql.columns.PsqlTableMetaColumns;
            ...
            return datasourceHolder.useConn(conn -> {
                ...
                while (rs.next()) {
                    ...
                    DbType dbType = DbType.builder()
                            .notNull(!strToBoolean(rs.getString(
                                    PsqlColumnMetaColumns.IS_NULLABLE.name())))
                            .type(rs.getString(
                                    PsqlColumnMetaColumns.TYPE_NAME.name()))
                            .build();
                    switch (dataType) {
                        // varchar
                        case 12:
