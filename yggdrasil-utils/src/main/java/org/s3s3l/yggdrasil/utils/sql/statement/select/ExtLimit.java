package org.s3s3l.yggdrasil.utils.sql.statement.select;


import org.s3s3l.yggdrasil.utils.common.StringUtils;
import org.s3s3l.yggdrasil.utils.sql.enumerations.DatabaseType;
...
public class ExtLimit extends Limit {
	...
	public String toString() {
		...
		switch (databaseType) {
			case MYSQL:
				retVal.append(" LIMIT ").append(offset).append(",").append(rowCount);
				break;
			case POSTGRESQL:
				retVal.append(" OFFSET ").append(offset).append(" LIMIT ").append(rowCount);
				break;
			case ORACLE:
			case SQLSERVER:
