package org.s3s3l.yggdrasil.utils.cache.redis;

import java.nio.charset.StandardCharsets;

import org.s3s3l.yggdrasil.utils.cache.RemoteCacheHolder;
import org.s3s3l.yggdrasil.utils.cache.checker.VersionChecker;
import org.s3s3l.yggdrasil.utils.cache.compressor.CompressConfiguration;
import org.s3s3l.yggdrasil.utils.cache.exception.CacheOperationException;
import org.s3s3l.yggdrasil.utils.collection.ArrayHelper;
...
public abstract class AbstractRedisCacheHolder implements RemoteCacheHolder<byte[], byte[]> {
     ...
     * 
     * @deprecated 不支持的操作
     * @see org.s3s3l.yggdrasil.utils.cache.ScopeCacheHolder#invalidate(java.lang.String)
     */
    @Deprecated
    @Override
     ...
     * 
     * @deprecated 不支持的操作
     * @see org.s3s3l.yggdrasil.utils.cache.CacheHolder#invalidateAll()
     */
    @Deprecated
    @Override
     ...
     * 
     * @deprecated 不支持的操作
     * @see org.s3s3l.yggdrasil.utils.cache.CacheHolder#refreshAll()
     */
    @Deprecated
    @Override
    ...
    /**
     * 
     * @see org.s3s3l.yggdrasil.utils.cache.ScopeCacheHolder#refresh(java.lang.String)
     */
    @Override
