...
import org.s3s3l.yggdrasil.utils.es.query.builder.RangeFieldBuilder;
import org.s3s3l.yggdrasil.utils.es.query.builder.RangeFieldCreator;
...
public class Range implements QueryBlock {
    ...
    public String toQueryString() {
        return String.format("{\"range\": %s}", JacksonUtils.nonNull.toJsonString(fields));
    }
